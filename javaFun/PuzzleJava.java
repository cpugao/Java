...
public class PuzzleJava {
    ...
    public void randomString() {
        ...
        String newString = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
        for (int i=0; i<5; i++) {
            randString.append(newString.charAt(rand.nextInt(newString.length())));
        }
